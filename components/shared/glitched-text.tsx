...
const TextWrapper = styled.div<{ animate: boolean }>`
  position: relative;
  line-height: 1;
  z-index: 2;
...
const TextContent = styled.span<{ animate: boolean }>`
  animation: ${pathKeyframes} 5s step-end infinite;
